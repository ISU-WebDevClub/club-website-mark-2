...
<div id="content">
    <div id="content-sub">
        <div id="home_page" class="tab_item">

        </div>
        <div id="about_page" class="tab_item" hidden>

        </div>
        <div id="portfolio_page" class="tab_item" hidden>

        </div>
        <div id="members_page" class="tab_item" hidden>

        </div>
        <div id="resources_page" class="tab_item" hidden>

        </div>
        <div id="contact_page" class="tab_item" hidden>
